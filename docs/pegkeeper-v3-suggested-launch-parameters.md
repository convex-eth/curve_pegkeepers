...
6. deploy standalone frxUSD keeper with final roles, reward share, and Policy;
7. deploy standalone USDC keeper with final roles, reward share, and Policy;
8. deploy standalone USDT keeper with final roles, reward share, and Policy.
...
1. batch-add frxUSD, USDC, and USDT keepers to Registry;
